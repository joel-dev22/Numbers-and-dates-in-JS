...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-10-17T14:43:26.374Z',
    '2022-10-18T18:49:59.371Z',
...
console.log(Number.parseFloat('30.22px', 10));
// NaN - Check value is NaN
console.log(Number.isNaN(+'40s'));
...
*/
/*
const subjects = ['AIC', 'CO', 'ACE', 'AET'];
const exams = setTimeout(
  (sub1, sub2) => console.log(`${sub1}, ${sub2}`),
  2000,
  ...subjects
);

if (subjects.includes('AfET')) clearTimeout(exams);
*/
